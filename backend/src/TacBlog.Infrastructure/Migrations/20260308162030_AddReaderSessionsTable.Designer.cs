...
namespace TacBlog.Infrastructure.Migrations
{
    ...
    [Migration("20260308162030_AddReaderSessionsTable")]
    partial class AddReaderSessionsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TacBlog.Domain.Like", b =>
                {
                    ...
                    b.HasKey("PostSlug", "VisitorId");

                    b.ToTable("likes", (string)null);
                });

            modelBuilder.Entity("TacBlog.Domain.ReaderSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("reader_sessions", (string)null);
                });
